...
export const $: g_liana.T.Type__Library<pd.SourceLocation> = {
    ...
    'global types': {
        'declarations': d({
            "AlgorithmTypeReference": globalTypeDeclaration({}),
            "Context": globalTypeDeclaration({}),
            "ModuleDefinition": globalTypeDeclaration({}),
            "Module": globalTypeDeclaration({}),
            "Project": globalTypeDeclaration({}),
            "Test": globalTypeDeclaration({}),
        }),
        'definitions': d({
            "AlgorithmTypeReference": globalTypeDefinition(
                group({
            ...
            "ModuleDefinition": globalTypeDefinition(
                group({
                    "glossary": prop(group({
