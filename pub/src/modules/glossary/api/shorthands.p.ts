...
export function _function(data: t.TTypeReference, returnValue: t.TTypeReference, async?: boolean): t.UGlossary.Pfunctions.D {
    return {
        'return type': ['data', {
            'type': returnValue,
...
export function procedure(data: t.TTypeReference): t.UGlossary.Pfunctions.D {
    return {
...
export function callback(data: t.TTypeReference, inf: t.TInterfaceReference): t.UGlossary.Pfunctions.D {
    return {
        'return type': ['nothing', null],
        'data': data,
        'managed input interface': null,
...
export function managedPipe(data: t.TTypeReference, in_inf: t.TInterfaceReference, out_inf: t.TInterfaceReference): t.UGlossary.Pfunctions.D {
    return {
        'return type': ['nothing', null],
        'data': data,
...
export function unmanagedPipe(data: t.TTypeReference, in_inf: t.TInterfaceReference, out_inf: t.TInterfaceReference): t.UGlossary.Pfunctions.D {
    return {
