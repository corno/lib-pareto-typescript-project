...
export namespace N {
    ...
    export namespace Delayed_$_$Type_$_$Path {
...
export namespace T {
    ...
    export namespace Delayed__Type__Path {
    ...
    export type Delayed__Type__Path<GAnnotation> = {
        ...
        export namespace D {
            ...
            export namespace _ltype {
                ...
                export namespace namespace {
                    ...
                    export type types<GAnnotation> = T.Global__Types<GAnnotation>
                }
                
                export type namespace<GAnnotation> = {
                    readonly 'types': T.Global__Types<GAnnotation>
                }
    ...
    export namespace Variable__Aggregates {
        ...
        export namespace D {
            ...
            export namespace source {
                ...
                export type aggregate<GAnnotation> = null
            ...
            export type source<GAnnotation> = 
                | ['aggregate', null]
                | ['parameter', null]
                | ['variable', null]
        }
    ...
    export type Variable__Aggregates<GAnnotation> = pt.Dictionary<{
        readonly 'source': 
            | ['aggregate', null]
            | ['parameter', null]
            | ['variable', null]
