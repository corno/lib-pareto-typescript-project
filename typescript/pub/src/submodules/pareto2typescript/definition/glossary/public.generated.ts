...
export type FSerializeAPI = <GPAnnotation>($: T.SerializeAPIData<GPAnnotation>, $i: gfp.IBlock,) => void

export type FSerializeBuildEnvironment = <GPAnnotation>($: gcommon.T.Null, $i: gfp.IDirectory,) => void

export type FSerializeGlossary = <GPAnnotation>($: T.SerializeGlossaryData<GPAnnotation>, $i: gfp.IDirectory,) => void
